    ...
    return (
        <div id={id} className={clsx(className, "flex flex-col")}>
            ...
            <div
                className={clsx(
                    containerClassName,
                    "bg-light-secondary border border-primary dark:border-none dark:bg-secondary rounded-3xl py-6 px-4 phone:p-3 w-[36rem] tablet:w-[24rem] phone:w-[20rem] tablet:self-center flex flex-col gap-y-6 phone:gap-y-3"
                )}>
                {children}
            </div>
        </div>
